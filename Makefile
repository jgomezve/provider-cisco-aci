# ====================================================================================
# Setup Project
PROJECT_NAME := provider-aci
PROJECT_REPO := github.com/jgomezve/$(PROJECT_NAME)
...
xpkg.build.provider-aci: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Aci CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Aci controllers
...
# This target prepares repo for your provider by replacing all "aci"
